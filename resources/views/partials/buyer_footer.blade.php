<footer class="bg-gradient-to-br from-green-950 to-zinc-950 w-full pt-24 pb-12 px-6 lg:px-12 mt-24 border-t border-white/10 relative overflow-hidden text-white">
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-16 w-full max-w-[1600px] mx-auto mb-20 relative z-10">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center pt-12 border-t border-white/10 max-w-[1600px] mx-auto relative z-10">
